package com.city.forum.mybatis;
...
public class MyPaginationInterceptor implements InnerInterceptor {
    ...
    public void beforePrepare(StatementHandler statementHandler, Connection connection, Integer transactionTimeout) {
        ...
        if (!id.startsWith("com.city.forum.mapper.DataMapper.selectPage")) {
            return;
        }
    ...
    private String getSql(String sql) {
        try {
            ...
            userIdExpression.setRightExpression(new LongValue(user.getUser().getUserId()));
            // 将两个条件拼接起来
