...
import com.city.forum.annotation.Auth;
import com.city.forum.model.entity.Resource;
import com.city.forum.security.MySecurityMetadataSource;
...
public class ApplicationStartup implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        //将资源数据批量添加到数据库
        resourceService.insertResource(list);
    }
    ...
    private List<Resource> getAuthResources(){
        ...
        handlerMethods.forEach((info,handlerMethod) -> {
            ...
            resource.setResource_type(1)
                    .setResourceName(methodAuth.name())
